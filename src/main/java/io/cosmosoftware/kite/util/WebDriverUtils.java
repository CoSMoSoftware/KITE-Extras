...
public class WebDriverUtils {
   ...
   */
  public static void clickElement(WebDriver webDriver, String elementDescription, By selector,
      boolean action) throws KiteInteractionException {
   ...
   */
  public static void clickElement(WebDriver webDriver, String elementDescription, By selector,
      int index, boolean action) throws KiteInteractionException {
    ...
    try {
      ...
      throw new KiteInteractionException(
          e.getClass().getName() + " in clicking element \"" + elementDescription + "\": " + e
  ...
  public static void drawSquare(WebDriver webDriver, Point begin, int squareSideLength) {
    ...
    if (isMobileApp(webDriver)) {
      ...
      for (int measure = squareSideLength / 20; measure <= squareSideLength;
          measure += squareSideLength / 20) {
   ...
   */
  public static WebElement getElement(WebDriver webDriver, String elementDescription, By selector)
      throws KiteInteractionException {
   ...
   */
  public static WebElement getElement(WebDriver webDriver, String elementDescription, By selector,
      int index) throws KiteInteractionException {
    ...
    if (index == -1) {
      try {
        ...
        throw new KiteInteractionException(
            "Could not find element: \"" + elementDescription + "\"");
      }
    } else {
   ...
   * @throws KiteInteractionException if an Exception occurs during method execution or fail.
   */
  public static String getText(WebDriver webDriver, String elementDescription, By selector)
      throws KiteInteractionException {
    ...
    try {
      ...
      throw new KiteInteractionException(
          e.getClass().getName() + " getting text from " + elementDescription);
    }
  }
   ...
   */
  private static boolean hasExpectedNumberOfElements(WebDriver webDriver, By selector,
      int expectedNumber) {
  ...
  public static boolean isIOS(WebDriver webDriver) {
    if (isMobileApp(webDriver)) {
      ...
      return platform.toUpperCase().equalsIgnoreCase("MAC") || platform.toUpperCase()
  ...
  public static void moveAppToBackground(WebDriver webDriver, Duration duration)
    ...
    try {
      ...
      throw new KiteInteractionException(
          "Failed to move app to background: " + e.getLocalizedMessage());
    }
  }
  ...
  public static void openAppWithBundleId(WebDriver webDriver, String bundleId)
    ...
    try {
      ...
      throw new KiteInteractionException(
          "Failed to open app with bundle ID: " + e.getLocalizedMessage());
    }
  }
   ...
   * @throws KiteInteractionException if an Exception occurs during method execution or fail.
   */
  public static void sendKeysToElement(WebDriver webDriver, String elementDescription, By selector,
      int index, String message) throws KiteInteractionException {
    WebElement element = getElement(webDriver, elementDescription, selector, index);
    try {
      waitAround(ONE_SECOND_INTERVAL / 2);
      try {
   ...
   */
  public static void sendKeysToElement(WebDriver webDriver, String elementDescription, By selector,
      String message) throws KiteInteractionException {
   ...
   * @throws KiteInteractionException the kite test exception
   */
  public static void swipe(WebDriver webDriver, Point begin, Point end)
      throws KiteInteractionException {
    try {
  ...
  public static void swipeUp(WebDriver webDriver) throws KiteInteractionException {
    Dimension size = getWindowSize(webDriver);
    swipe(webDriver, new Point(size.width / 2, size.height / 2),
        new Point(size.width / 2, size.height - 10));
  }

  /**
   * Performs a swipe up action from the bottom middle of the screen, all the way down to the top
  ...
  public static void swipeUpFromBottom(WebDriver driver) throws KiteInteractionException {
    ...
    swipe(driver, new Point(size.getWidth() / 2, size.getHeight() - 1),
        new Point(size.getWidth() / 2, 1));
  }
   ...
   * @param y the y
   */
  public static void tap(WebDriver webDriver, int x, int y, int times)
      throws KiteInteractionException {
    try {
      TouchAction action = new TouchAction((MobileDriver) webDriver);
      ...
      throw new KiteInteractionException(e.getClass().getName() + " while tapping on device",
          e.getCause());
    }
  }
   ...
   * @throws KiteInteractionException if an Exception occurs during method execution or fail.
   */
  public static void waitForElement(WebDriver webDriver, By selector)
      throws KiteInteractionException {
   ...
   * @throws KiteInteractionException if an Exception occurs during method execution or fail.
   */
  public static void waitForElement(WebDriver webDriver, By selector, int timeout)
      throws KiteInteractionException {
   ...
   * @throws KiteInteractionException if an Exception occurs during method execution or fail.
   */
  public static void waitForExpectedNumberOfElements(WebDriver webDriver, By selector,
      int expectedNumber) throws KiteInteractionException {
